...
export type RoadsterQuery = { __typename?: 'Query', roadster?: { __typename?: 'Roadster', apoapsis_au?: number | null, details?: string | null, earth_distance_km?: number | null, earth_distance_mi?: number | null, eccentricity?: number | null, epoch_jd?: number | null, inclination?: number | null, launch_date_unix?: any | null, launch_date_utc?: any | null, launch_mass_kg?: number | null, launch_mass_lbs?: number | null, longitude?: number | null, mars_distance_km?: number | null, mars_distance_mi?: number | null, name?: string | null, norad_id?: number | null, periapsis_arg?: number | null, periapsis_au?: number | null, period_days?: number | null, semi_major_axis_au?: number | null, speed_kph?: number | null, speed_mph?: number | null, wikipedia?: string | null } | null };
...
export const LaunchesPastDocument = gql`
  ...
  export class LaunchesPastGQL extends Apollo.Query<LaunchesPastQuery, LaunchesPastQueryVariables> {
    override document = LaunchesPastDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const RoadsterDocument = gql`
    query Roadster {
  roadster {
    apoapsis_au
    details
  ...
  export class RoadsterGQL extends Apollo.Query<RoadsterQuery, RoadsterQueryVariables> {
    override document = RoadsterDocument;
